...
override PKGDIR = xconfig_appBLE
...
ti.targets.arm.elf.M3.rootDir ?= C:/ti/ccsv6/tools/compiler/ti-cgt-arm_15.9.0.STS
...
package/%.xdc.inc package/%_xconfig_appBLE.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_appBLE" (because $@ is older than $(firstword $?))" ...
...
appBLE.xem3: package/cfg/appBLE_pem3.oem3 
	...
	@$(MSG) lnkem3 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M3.rootDir)/bin/armlnk -w -q -u _c_int00  -q -o $@ package/cfg/appBLE_pem3.oem3   package/cfg/appBLE_pem3.xdl --silicon_version=7M3 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M3.rootDir)/lib/libc.a
...
.PHONY: release,xconfig_appBLE
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_appBLE.tar.dep
endif
package/rel/xconfig_appBLE/xconfig_appBLE/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_appBLE/xconfig_appBLE/package/package.rel.xml: package/build.cfg
package/rel/xconfig_appBLE/xconfig_appBLE/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_appBLE/xconfig_appBLE/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_appBLE.tar: package/rel/xconfig_appBLE.xdc.inc package/rel/xconfig_appBLE/xconfig_appBLE/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_appBLE.xdc.inc,package/rel/xconfig_appBLE.tar.dep)


release release,xconfig_appBLE: all xconfig_appBLE.tar
clean:: .clean
	-$(RM) xconfig_appBLE.tar
	-$(RM) package/rel/xconfig_appBLE.xdc.inc
	-$(RM) package/rel/xconfig_appBLE.tar.dep
